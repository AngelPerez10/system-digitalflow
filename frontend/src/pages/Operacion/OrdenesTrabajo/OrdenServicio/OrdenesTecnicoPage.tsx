  ...
  return (
    ...
    <div className="mx-auto w-full max-w-[min(100%,1920px)] space-y-5 px-3 pb-10 pt-5 text-sm sm:space-y-6 sm:px-5 sm:pb-12 sm:pt-6 sm:text-base md:px-6 lg:px-8 xl:px-10 2xl:max-w-[min(100%,2200px)]">
      ...
      >
        ...
        <span className="font-medium text-gray-700 dark:text-gray-300">Mis órdenes</span>
      </nav>
      ...
      <header className={`flex w-full flex-col gap-4 ${cardShellClass} p-4 sm:p-6`}>
        <div className="flex min-w-0 gap-3 sm:gap-4">
          ...
          <div className="min-w-0 flex-1">
            ...
            <h1 className="mt-0.5 text-lg font-semibold tracking-tight text-gray-900 dark:text-white sm:text-xl md:text-2xl">Mis órdenes</h1>
                ...
                <div>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      rows={2}
                      className={`w-full rounded-lg border border-gray-300 dark:border-gray-700 text-sm px-3 py-2 pr-12 shadow-theme-xs outline-none resize-none ${isReadOnly ? 'bg-gray-100 text-gray-600 cursor-not-allowed dark:bg-gray-800/50 dark:text-gray-400' : 'bg-white text-gray-800 dark:bg-gray-800 dark:text-gray-200 focus:border-brand-500 focus:ring-2 focus:ring-brand-200/70'}`}
