...
/**
 * Tarjetas de resumen — mismo formato visual que Órdenes / Pólizas.
 */
export function ProyectosPageStats({ stats }: Props) {
  return (
    ...
    >
      <div className={erpStatCardClass}>
        <div className="flex items-center gap-2.5 sm:gap-3">
          ...
          <div className="min-w-0">
            <p className="text-[9px] font-semibold uppercase tracking-wide text-[#6E6E77] sm:text-[10px]">Total</p>
      ...
      <div className={erpStatCardClass}>
        <div className="flex items-center gap-2.5 sm:gap-3">
          <span className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-sky-200/80 bg-sky-50/90 text-sky-800 dark:border-sky-500/25 dark:bg-sky-500/10 dark:text-sky-300 sm:h-10 sm:w-10">
            <svg viewBox="0 0 24 24" className="h-4 w-4 sm:h-5 sm:w-5" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden>
              <path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </span>
          <div className="min-w-0">
            <p className="text-[9px] font-semibold uppercase tracking-wide text-[#6E6E77] sm:text-[10px]">En proceso</p>
            <p className="mt-0.5 text-base font-semibold tabular-nums text-[#09090B] dark:text-white sm:text-lg">
      ...
      <div className={erpStatCardClass}>
        <div className="flex items-center gap-2.5 sm:gap-3">
          ...
          <div className="min-w-0">
            <p className="text-[9px] font-semibold uppercase tracking-wide text-[#6E6E77] sm:text-[10px]">Pausados</p>
            <p className="mt-0.5 text-base font-semibold tabular-nums text-[#09090B] dark:text-white sm:text-lg">
              {stats.pausados.toLocaleString("es-MX")}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className={erpStatCardClass}>
        <div className="flex items-center gap-2.5 sm:gap-3">
          ...
          <div className="min-w-0">
            <p className="text-[9px] font-semibold uppercase tracking-wide text-[#6E6E77] sm:text-[10px]">Cerrados</p>
            <p className="mt-0.5 text-base font-semibold tabular-nums text-[#09090B] dark:text-white sm:text-lg">
              {stats.cerrados.toLocaleString("es-MX")}
            </p>
          </div>
        </div>
      </div>
