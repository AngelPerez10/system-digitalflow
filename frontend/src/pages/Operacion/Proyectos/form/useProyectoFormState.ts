...
export function useProyectoFormState({
  ...
  const buildCurrentDraft = useCallback((): ProyectoDraft => {
    ...
    return {
      ...
      statusChangedByAvatarUrl: initialDraft.statusChangedByAvatarUrl || "",
      statusChangedAt: initialDraft.statusChangedAt || "",
      liquidado: initialDraft.liquidado || false,
      liquidadoPorNombre: initialDraft.liquidadoPorNombre || "",
      liquidadoPorAvatarUrl: initialDraft.liquidadoPorAvatarUrl || "",
      liquidadoAt: initialDraft.liquidadoAt || "",
      creadoPorName: initialDraft.creadoPorName || "",
      creadoPorAvatarUrl: initialDraft.creadoPorAvatarUrl || "",
