...
export default function IaPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        <div className="relative h-[calc(100vh-146px)] px-4 xl:px-0">
          <div className="my-6 flex items-center justify-between rounded-2xl border border-gray-200 bg-white p-3 xl:hidden dark:border-gray-800 dark:bg-gray-900">
            <div className="min-w-0">
              <div className="text-[11px] font-semibold uppercase tracking-wide text-gray-400">Historial</div>
              <h4 className="truncate pl-0 text-lg font-semibold text-gray-800 dark:text-white/90">Chats</h4>
            </div>
            <button
              type="button"
          ...
          <div className="grid h-full grid-cols-1 xl:grid-cols-[320px_1fr]">
            ...
            <div className="flex-1 xl:py-10">
              <div className="relative mx-auto flex max-w-[860px] flex-col">
                <div className="mb-3 rounded-2xl border border-gray-200 bg-white px-4 py-3 dark:border-gray-800 dark:bg-gray-900">
                  <div className="flex items-center justify-between gap-3">
                    <div className="min-w-0">
                      <div className="text-[11px] font-semibold uppercase tracking-wide text-gray-400">Conversación</div>
                      <div className="truncate text-sm font-semibold text-gray-800 dark:text-white/90">
                        {(conversations || []).find((c) => c.id === activeConversationId)?.title || 'Nuevo chat'}
                      </div>
                    </div>
                    <div className="flex shrink-0 items-center gap-2">
                      <button
                        ...
                        className="inline-flex items-center gap-2 rounded-xl bg-gray-900 px-3 py-2 text-xs font-semibold text-white hover:bg-gray-800 dark:bg-white/90 dark:text-gray-900 dark:hover:bg-white"
                      >
                      ...
                      <button
                        type="button"
                        onClick={() => setIsSidebarOpen(true)}
                        className="inline-flex items-center justify-center rounded-xl border border-gray-300 bg-white p-2 text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-white/5 xl:hidden"
                        aria-label="Abrir historial"
                      >
                ...
                <div className="custom-scrollbar relative z-20 flex-1 space-y-7 overflow-y-auto pb-28 lg:pb-24">
                {error && (
                ...
                {messages.length === 0 && !error && (
                  <div className="rounded-3xl border border-gray-200 bg-white px-5 py-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
                    <div className="flex items-start gap-4">
                      <div className="flex h-10 w-10 items-center justify-center rounded-2xl border border-gray-200 bg-gray-50 text-gray-700 dark:border-gray-800 dark:bg-gray-950 dark:text-gray-200">
                        <MessageSquarePlus className="h-5 w-5" />
                      </div>
                      <div className="min-w-0">
                        <div className="text-sm font-semibold text-gray-800 dark:text-white/90">Inicia un chat</div>
                        <div className="mt-1 text-sm leading-6 text-gray-600 dark:text-gray-300">
                          Escribe tu pregunta abajo. Si el servicio responde 502, normalmente es un problema temporal del proveedor.
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="fixed bottom-4 left-1/2 z-20 w-full -translate-x-1/2 transform px-4 sm:px-6 lg:bottom-8 lg:px-8">
                <div className="mx-auto w-full max-w-[900px] rounded-3xl border border-gray-200 bg-white/90 p-4 shadow-theme-xs backdrop-blur dark:border-gray-800 dark:bg-gray-900/80">
                  <textarea
        ...
        >
          ...
          >
            <div className="flex items-center justify-between gap-3">
              ...
              <button
                type="button"
                className="inline-flex h-9 w-9 items-center justify-center rounded-xl border border-gray-200 bg-white text-gray-700 hover:bg-gray-50 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-white/5"
                onClick={() => {
                  setRenameConversationId(null);
                  setRenameTitle('');
                }}
