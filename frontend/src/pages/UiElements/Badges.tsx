...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="Insignias | Sistema Grupo Intrax GPS"
        description="Página de insignias para el sistema de administración Grupo Intrax GPS"
      />
      <PageBreadcrumb pageTitle="Insignias" />
      <div className="space-y-5 sm:space-y-6">
        <ComponentCard title="Con Fondo Claro">
        ...
        <ComponentCard title="Con Fondo Sólido">
          <div className="flex flex-wrap gap-4 sm:items-center sm:justify-center">
            {/* Light Variant */}
        ...
        <ComponentCard title="Fondo Claro con Icono Izquierdo">
          <div className="flex flex-wrap gap-4 sm:items-center sm:justify-center">
        ...
        <ComponentCard title="Fondo Sólido con Icono Izquierdo">
          <div className="flex flex-wrap gap-4 sm:items-center sm:justify-center">
        ...
        <ComponentCard title="Fondo Claro con Icono Derecho">
          <div className="flex flex-wrap gap-4 sm:items-center sm:justify-center">
        ...
        <ComponentCard title="Fondo Sólido con Icono Derecho">
          <div className="flex flex-wrap gap-4 sm:items-center sm:justify-center">
