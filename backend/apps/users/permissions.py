...
class ProyectosAttachmentPermission(BasePermission):
    """
    Subida/borrado de imágenes de proyectos (evidencias, bitácora, firmas).
    POST permitido con create o edit — los técnicos suelen tener solo edit.
    """
