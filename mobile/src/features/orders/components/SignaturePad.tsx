    ...
    <View style={styles.wrap}>
      {hayFirma ? (
        ...
        <Pressable
          ...
          style={({ pressed }) => [styles.ctaVacio, pressed ? styles.ctaPressed : null]}
        >
          <Text style={styles.ctaTitulo}>Toca para firmar</Text>
          <Text style={styles.ctaSub}>Lienzo a pantalla completa · trazo fluido</Text>
        </Pressable>
      )}
        ...
        {hayFirma ? (
          <>
            <Pressable
              ...
              disabled={disabled}
              onPress={() => setAbierto(true)}
              style={({ pressed }) => [styles.botonSec, pressed ? styles.botonPressed : null]}
            >
              <Text style={styles.botonSecTexto}>Volver a firmar</Text>
            </Pressable>
            <Pressable
              accessibilityRole="button"
              ...
              style={({ pressed }) => [styles.botonSec, pressed ? styles.botonPressed : null]}
            >
              <Text style={styles.botonSecTexto}>Borrar</Text>
            </Pressable>
          </>
        ) : null}
      </View>
...
function FirmaModal({
  ...
  return (
    ...
    >
      ...
      <View style={[styles.modal, { paddingTop: insets.top, paddingBottom: Math.max(insets.bottom, spacing.sm) }]}>
        <View style={styles.modalChrome}>
          <Pressable
            accessibilityRole="button"
            accessibilityLabel="Cerrar firma"
            onPress={onClose}
            style={({ pressed }) => [styles.modalLink, pressed ? styles.botonPressed : null]}
          >
            <Text style={styles.modalLinkTexto}>Cancelar</Text>
          </Pressable>
          ...
          >
            <Text style={styles.modalLinkTexto}>Limpiar</Text>
          </Pressable>
        </View>

        <Text style={styles.modalHint}>Deslice el dedo con naturalidad — el trazo se suaviza solo</Text>
        ...
        <Pressable
          ...
          style={({ pressed }) => [
            styles.botonPri,
            pressed ? styles.botonPriPressed : null,
...
const styles = StyleSheet.create({
  ...
  ctaPressed: { backgroundColor: colors.line },
  ctaTitulo: { ...type.bodyMedium, color: colors.primary },
  ctaSub: { ...type.caption, color: colors.inkMuted, textAlign: 'center' },
  preview: {
    height: 148,
  ...
  botonSecTexto: { ...type.label, color: colors.ink },
  botonPressed: { backgroundColor: colors.surfaceSunken },
  ...
  botonPriPressed: { backgroundColor: colors.primaryPressed },
  botonPriTexto: { ...type.button, color: colors.onPrimary },
  ...
  modalTitulo: { ...type.bodyMedium, color: colors.ink },
  modalLink: { minHeight: TOUCH_TARGET, justifyContent: 'center', paddingHorizontal: spacing.sm },
  modalLinkTexto: { ...type.label, color: colors.primary },
  modalHint: {
    ...type.caption,
